...
config.add_section("mp3tunes")
config.set("mp3tunes", "username", "")
config.set("mp3tunes", "password", "")
config.set("mp3tunes", "partner_token", "")
config.read(os.path.join(os.getenv("PLAYDAR_ETC", "etc"), "mp3tunes.conf"))

MP3TUNES_USER = config.get("mp3tunes", "username")
MP3TUNES_PASS = config.get("mp3tunes", "password")
MP3TUNES_TOKEN = config.get("mp3tunes", "partner_token")
